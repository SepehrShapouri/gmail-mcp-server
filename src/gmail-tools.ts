...
// Create the tool handler for a given Gmail client
export function createToolHandler(gmail: gmail_v1.Gmail) {
    return async function handleToolCall(name: string, args: unknown) {
